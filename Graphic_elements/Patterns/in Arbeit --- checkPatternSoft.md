...
# checkPattern  [![](images/checkPattern-thumbnail.png)](images/checkPattern.png)

**Function call:** `fn_checkPatternSoft (uv0, COLOUR1, COLOUR2, LINES, EDGE_SHARPNESS);`  

Example with values: `fn_checkPatternSoft (uv0, COLOUR1, WHITE, LINES1, 1000.0);`
